...
void store_energy(
        const int x, const int y, SyclBuffer& energyBuff, SyclBuffer& energy0Buff, queue& device_queue);
...
void cheby_iterate(
        ...
        const double alpha, const double beta, SyclBuffer& pBuff, SyclBuffer& rBuff, SyclBuffer& uBuff, SyclBuffer& u0Buff,  SyclBuffer& wBuff,
        SyclBuffer& kxBuff, SyclBuffer& kyBuff, queue& device_queue);
...
void cg_calc_w(
        ...
        SyclBuffer& pBff, SyclBuffer& kxBuff, SyclBuffer& kyBuff, double* pw, queue& device_queue);
...
void jacobi_iterate(
        const int x, const int y, const int halo_depth, SyclBuffer& u,
        SyclBuffer& u0, SyclBuffer& r, SyclBuffer& kx, SyclBuffer& ky,
