...
void jacobi_init(
	const int x, const int y, const int halo_depth, const int coefficient,
	const double rx, const double ry, SyclBuffer& uBuff, SyclBuffer& u0Buff,
	SyclBuffer& densityBuff, SyclBuffer& energyBuff, SyclBuffer& kxBuff,
...
void jacobi_iterate(
  ...
  SyclBuffer& u0Buff, SyclBuffer& rBuff, SyclBuffer& kxBuff,
	SyclBuffer& kyBuff, double* error, queue& device_queue)
{
